...
<head>
    ...
    <title>Admin Dashboard - Parker School</title>
    <!-- General CSS Files -->
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('admin') ?>">Parker <sup></sup></a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    <div class="card-header">
                                        <h4>Mail Pengunjung</h4>
                                    </div>
                                    <div class="card-body">
                                        <?php echo $this->db->count_all('feedback'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Welcome, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Website ini adalah website khusus untuk admin Parker International Junior High School</p>
                                <div class="mt-4">
